module ApplicationHelper
  ...
  def sidebar_icon(name)
    paths = {
      copilot: ["M12 3 1.2 3.8L17 8l-3.8 1.2L12 13l-1.2-3.8L7 8l3.8-1.2Z", "M19 14l.8 2.2L22 17l-2.2.8L19 20l-.8-2.2L16 17l2.2-.8Z"],
      new_consultation: ["M12 5v14", "M5 12h14"],
      history: ["M3 12a9 9 0 1 0 3-6.7", "M3 4v5h5", "M12 7v5l3 2"],
      settings: ["M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7Z", "M19.4 15a1.7 1.7 0 0 0 .34 1.88l.06.06-2 3.46-.08-.02a1.7 1.7 0 0 0-1.8.12l-.14.08a1.7 1.7 0 0 0-.86 1.68V22h-4v-.1a1.7 1.7 0 0 0-.95-1.53l-.16-.08a1.7 1.7 0 0 0-1.85.13l-.06.05-2-3.46.07-.06a1.7 1.7 0 0 0 .35-1.88l-.06-.16A1.7 1.7 0 0 0 4.7 14H4v-4h.7a1.7 1.7 0 0 0 1.55-.92l.08-.16a1.7 1.7 0 0 0-.35-1.88l-.07-.06 2-3.46.06.05a1.7 1.7 0 0 0 1.85.13l.16-.08A1.7 1.7 0 0 0 10.92 2V2h4v.1a1.7 1.7 0 0 0 .86 1.53l.14.08a1.7 1.7 0 0 0 1.8-.12l.08-.02 2 3.46-.06.06a1.7 1.7 0 0 0-.34 1.88l.06.16A1.7 1.7 0 0 0 21 10h.7v4H21a1.7 1.7 0 0 0-1.54.92Z"],
