...
module AI
  class DecisionService
    ...
    CONNECT_TIMEOUT_SECONDS = ENV.fetch("AI_CONNECT_TIMEOUT_SECONDS", 3).to_i
    RESPONSE_TIMEOUT_SECONDS = ENV.fetch("AI_RESPONSE_TIMEOUT_SECONDS", 48).to_i
    TOTAL_DEADLINE_SECONDS = ENV.fetch("AI_TOTAL_DEADLINE_SECONDS", 50).to_i
    AI_SERVICE_DEADLINE_SECONDS = ENV.fetch("AI_SERVICE_DEADLINE_SECONDS", 45).to_i
